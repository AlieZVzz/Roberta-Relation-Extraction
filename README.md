# Bert In Relation Extraction fixed

```
本项目基于https://github.com/Ricardokevins/Bert-In-Relation-Extraction项目修改，
包括添加log checkpoints 修改模型为roberta，同时添加了一些超参数的调试，包括scheduler warmup weight decay
在60000条数据训练，测试2000条数据准确率为0.9516129032258065
```
